...
from GilbertAnimeBot import dispatcher, telethn
from GilbertAnimeBot.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("GilbertAnimeBot.modules.", 1)[1]
